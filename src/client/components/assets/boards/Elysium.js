...
export default [
  ...
  [
    { resources: ['titanium', 'titanium'], text: 'Elysium Mons', attrs: ['volcano'] },
    {},
    { resources: ['card'] },
    {},
    { resources: ['plant'], attrs: ['reserved-ocean'] },
    { attrs: ['reserved-ocean'] },
    { resources: ['card', 'card', 'card'], text: 'Olympus Mons', attrs: ['volcano'] }
  ],
  [
    { resources: ['plant'] },
    { resources: ['plant'] },
  ...
  [
    ...
    { resources: ['plant', 'plant'] },
    { resources: ['plant', 'plant'] },
    { resources: ['titanium', 'plant'], text: 'Arsia Mons', attrs: ['volcano'] }
  ],
  [
    { resources: ['steel'] },
    { resources: ['plant'] },
