...
export default class Player extends Component {
  render() {
    return (
      <div className={classNames('player', { active: this.props.turn, passed: this.props.player.passed })} onClick={this.props.onClick} onMouseDown={e => e.stopPropagation()} onMouseMove={e => e.stopPropagation()}>
