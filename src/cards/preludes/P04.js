...
import { Param, Resource, Production } from '../../client/components/assets/Assets';
...
export default new Prelude({
  ...
  set: 'prelude',
  desc,
  flavor: 'Bioengineering is of the utmost importance on Mars, and you just got a head start',
  emoji: '🥼',
  layout: (
