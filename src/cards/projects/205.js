...
const desc = 'Decrease your energy production 1 step. Raise your terraform rating 2 steps.';
...
export default new Automated({
  ...
  tags: ['building'],
  desc,
  flavor: 'Certain aromatic compounds can absorb dangerous radiation without breaking',
  clientAction: game => {},
  serverAction: game => {},
  emoji: '🧬',
  layout: (
