...
const desc = 'Requires -20°C or warmer. Increase your M€ production 1 step and gain 2 plants.';
...
export default new Automated({
  ...
  desc,
  flavor: 'Utilizing the uniquely dense and moist atmosphere in the canyons of Noctis Labyrinthus',
  clientAction: game => {},
  serverAction: game => {},
  vp: 1,
  emoji: '🚜',
