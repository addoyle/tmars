...
const desc = 'Increase your energy production and your steel production 1 step each.';
...
export default new Automated({
  ...
  desc,
  flavor: 'Fuel production and metal refining can be programmed into microorganisms',
  clientAction: game => {},
  serverAction: game => {},
  emoji: '🦠️',
  layout: (
